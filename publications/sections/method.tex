...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \STATE{\(
            \ui{E}{B} \gets \sum_{i = k - a - b - c}^{k - b - c} \left \| \ui{\bar{X}}{B}{i} - \Phi \ui{\tilde{\bar{X}}}{B}{i} \right \|_F^2 \newline
            \ui{E}{T} \gets \sum_{i = k - c}^{k} \left \| \ui{\bar{X}}{T}{i} - \Phi \ui{\tilde{\bar{X}}}{T}{i} \right \|_F^2
            \)}
